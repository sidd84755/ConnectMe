...
export declare type CampaignSortField = {
    field: string;
    value: any;
};
...
export declare type RecipientQueryOptions = CampaignQueryOptions;
export declare type SegmentFilters = {};
export declare type CampaignFilters = {};
export declare type RecipientFilters = {};
...
export declare type CampaignStatusName = 'draft' | 'stopped' | 'scheduled' | 'completed' | 'failed' | 'in_progress';
...
export declare type TestCampaignResponse = {
    status: CampaignStatusName;
    details?: string;
